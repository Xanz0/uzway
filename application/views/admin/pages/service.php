            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-bordered table-hover" id="order-listing">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>Заголовок <i class="flag-icon flag-icon-ru" title="ru" id="ru"></th>
                        <th>Заголовок <i class="flag-icon flag-icon-uz" title="uz" id="uz"></th>
                        <th>Заголовок <i class="flag-icon flag-icon-gb" title="en" id="en"></th>
                        <th>Категория</th>
                        <th>Редактировать</th>
                      </tr>
                    </thead>
